import { CrowdinApi, PaginationOptions, ResponseList, ResponseObject, Status } from '../core';
...
export declare class TranslationStatus extends CrowdinApi {
     ...
     */
    revalidateQaChecks(projectId: number, request?: TranslationStatusModel.RevalidateQaChecksRequest): Promise<ResponseObject<Status<TranslationStatusModel.QaChecksRevalidationAttributes>>>;
    /**
     * @param projectId project identifier
     ...
     */
    getQaChecksRevalidationStatus(projectId: number, revalidationId: string): Promise<ResponseObject<Status<TranslationStatusModel.QaChecksRevalidationAttributes>>>;
    /**
     * @param projectId project identifier
     * @param revalidationId QA checks revalidation identifier
...
export declare namespace TranslationStatusModel {
    ...
    interface RevalidateQaChecksRequest {
        qaCheckCategories?: string[];
        languageIds?: string[];
        failedOnly?: boolean;
    }
    interface QaChecksRevalidationAttributes {
        languageIds: string[];
        qaCheckCategories: string[];
        failedOnly: boolean;
    }
