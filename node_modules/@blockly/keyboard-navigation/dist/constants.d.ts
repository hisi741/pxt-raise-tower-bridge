 ...
 */
export declare enum SHORTCUT_NAMES {
    UP = "up",
    DOWN = "down",
    RIGHT = "right",
    LEFT = "left",
...
export declare const SHORTCUT_NAMES_TO_DISPLAY_TEXT: Record<string, string>;
/**
 * Types of possible messages passed into the loggingCallback in the Navigation
 * class.
 */
export declare enum LOGGING_MSG_TYPE {
    ERROR = "error",
    WARN = "warn",
    LOG = "log"
}
 ...
 */
export declare const SHORTCUT_CATEGORIES: Record<string, Array<SHORTCUT_NAMES | 'undo' | 'redo' | 'delete'>>;
