 ...
 */
import { WorkspaceSvg, IDraggable, IFocusableNode, IBoundedElement, ISelectable } from 'blockly';
...
export declare class MoveActions {
     ...
     *     could be found.
     */
    getCurrentDraggable(workspace: WorkspaceSvg): (IDraggable & IFocusableNode & IBoundedElement & ISelectable) | undefined;
}
