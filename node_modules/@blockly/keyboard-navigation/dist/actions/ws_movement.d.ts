 ...
 * shortcuts.
 */
export declare class WorkspaceMovement {
    private navigation;
     ...
     *     otherwise.
     */
    moveWSCursor(workspace: WorkspaceSvg, xDirection: number, yDirection: number): boolean;
    /**
     * Moves the cursor to the workspace near the origin.
     *
     * @param workspace The workspace the cursor is on.
     */
    createWSCursor(workspace: WorkspaceSvg): boolean;
}
//# sourceMappingURL=ws_movement.d.ts.map