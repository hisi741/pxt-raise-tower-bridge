 ...
 */
export declare class ShortcutDialog {
    ...
    constructor();
    getPlatform(): string;
    toggle(workspace: Blockly.WorkspaceSvg): void;
    toggleInternal(): void;
    /**
     ...
     */
    getReadableShortcutName(shortcutName: string): string;
    /**
     * List all currently registered shortcuts as a table.
     */
    createModalContent(): void;
    private getTableRowForShortcut;
    private actionShortcutsToHTML;
    private keysToHTML;
    /**
...
//# sourceMappingURL=shortcut_dialog.d.ts.map