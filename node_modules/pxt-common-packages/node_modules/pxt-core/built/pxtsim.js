...
(function (pxsim) {
    ...
    (function (AudioContextManager) {
        ...
        function stopTone() {
            AudioContextManager.AudioToneSource.dispose();
            if (audio) {
                audio.pause();
            }
        }
                            ...
                            if (noteEvent.startTick === this._currentTick) {
                                for (const note of noteEvent.notes) {
                                    if (this.spatialAudioPlayer) {
                                        if (track.drums) {
                                            playDrumAtSpatialAudioPlayerAsync(this.spatialAudioPlayer, track.drums[note.note], this.getDrumTrackVolume(i, note.note));
                                        }
                                        else {
                                            playNoteAtSpatialAudioPlayerAsync(this.spatialAudioPlayer, note.note, track.instrument, tickToMs(this.currentlyPlaying.beatsPerMinute, this.currentlyPlaying.ticksPerBeat, noteEvent.endTick - noteEvent.startTick), this.getMelodicTrackVolume(i));
                                        }
                                    }
                                    else {
                                        if (track.drums) {
