...
export declare function cleanUpBlocklySvg(svg: SVGElement, sourceSvg: SVGElement): SVGElement;
...
export declare function isDisabledBlocklyElement(element: Element): boolean;
