...
declare namespace pxsim.music {
    ...
    class Sequencer {
        ...
        protected getMelodicTrackVolume(trackIndex: number, velocity: number): number;
        protected getDrumTrackVolume(trackIndex: number, drumIndex: number, velocity: number): number;
